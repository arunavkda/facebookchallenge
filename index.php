...
$facebook = new Facebook(array(
  ...
  'secret' => '0db37bbceb9e7e3face3f18638c759a5',
));
...
if ($user) {
  try {
    // Get the user profo ile data you have permission to view
...
?>
					...
					<div class="container">
						...
						<div id="navbar-collapse-menu" class="collapse navbar-collapse menu-links">
							<ul class="nav navbar-nav pull-right">
								...
								<li>
									<a href="<?php echo  $fb_logout_url ;?>" class="center">
				...
				<div class="container" id="main-div">
					...
					<div class="row">
						...
						<?php
						include( 'libs/resize_image.php' );
						
						//echo $user_id;
							// graph api request for user data
							$request_albums = new FacebookRequest( $session, "GET", "/".$user_id."/albums?fields=id,cover_photo,from,name" );
										...
										foreach ( $album_photos['data'] as $album_photo ) {
											...
											if ( $album['cover_photo'] == $album_photo['id'] ) {
												...
												/*if ( !file_exists( $album_resized_cover_photo ) )
													resizeTo($album_cover_photo , null, 350 , 420 , false , $album_resized_cover_photo , false , false , 100 );
												...
												<div class="col-sm-6 col-md-4">
													<div class="thumbnail no-border center">
														...
														<a href="<?php echo $album_photo['source'];?>" class="fancybox" rel="<?php echo $album['id'];?>">
														  <img src="<?php echo $album_photo['source'];?>" class="image-responsive img-rounded" alt="<?php echo $album['name'];?>" />
														</a>
